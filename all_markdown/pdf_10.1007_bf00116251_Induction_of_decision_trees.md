...
" I
P: p~
/ true fals \ e /t rue false \ high normal high normal
P: P" N.
sunny o'cast rain
true false
/
...
P • (1 - ~P ) + n . (1 n_~_) _ 2pn
p+n p+n p+n p+n (p+n) 2
...
fnachinery to fall over a cliff. For this task, a 5°7o noise level in a single attribute pro-
...
96 J.R. QUINLAN
noise level in class information results in a 3°70 degradation. Comparable figures have
...
method
1 2 3
Bayesian 28% 27% 38°7o
Decision tree 19% 22% 19070
Most common value 28°7o 27°70 4007o
...
•3 9 attributes. Various 'ignorance levels' analogous to the earlier noise levels were ex-
...
ASSISTANT (Kononenko et al, 1984) solves this problem by requiring that all test~
...
5 log2 5 4 log2 4 5 log2 5
IV(outlook) = - 14 14 14 14 14 14
= 1.578 bits
Similarly,
7 7 7 7
IV(humidity) - log2 log2 .~ = 1 bit
14 14 14 41
So,
...
Michalski, R.S (1980). Pattern recognition as rule-guided inductive inference. 1EEE Transactions on Pat-
...
Michalski, J.G. CarboneU & T.M. Mitchell (Eds.), Machine learning: An artificial intelligence ap-
proach. Palo Alto: Tioga Publishing Company.
