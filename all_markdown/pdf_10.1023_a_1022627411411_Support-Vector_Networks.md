...
recognition. He considered a model of two normal distributed populations, N(m , EI)
1
and N(m , E ) of n dimensional vectors x with mean vectors m and m and co-variance
2 2 1 2
matrices E1 and E2, and showed that the optimal (Bayesian) solution is a quadratic decision
function:
In the case where E = E = E the quadratic decision function (1) degenerates to a linear
1 2
function:
...
with respect to Ar = (a1,..., at), subject to the constraints:
where 1T = (1,..., 1) is an -dimensional unit vector, Yr = (yi y^) is the £-dimen-
...
C1. 0 Cl. 1 Cl. 2 Cl. 3 Cl. 4 Cl. 5 Cl. 6 Cl. 7 Cl. 8 Cl. 9
...
A>:
Substituting this equality into the expression (46) for W(A0) we obtain
...
and the multipliers Rr = (r\, r2,...., r1) enforce the constraint (50).
